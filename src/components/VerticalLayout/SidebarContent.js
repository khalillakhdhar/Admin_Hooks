          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/#" className="has-arrow">
                ...
                <span>{props.t("Tableau de board")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
                  <Link to="/dashboard">{props.t("Statistiques")}</Link>
                </li>
              {/*  <li>
            ...
            <li className="menu-title">{props.t("Interactions")}</li>
...
*/}
            <li>
              <Link to="/#" className="has-arrow ">
                ...
                <span>{props.t("Reclamations")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
                  <Link to="/email-inbox">{props.t("Liste")}</Link>
                </li>
                {/*<li>
...
*/}
            <li>
              ...
              {/*  <li>
                ...
                <li>
                  <Link to="/contacts-list">{props.t(" Gestion")}</Link>
                </li>
                <li>
